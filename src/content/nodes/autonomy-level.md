...
[background execution](background-execution) or a scheduled task cannot fall
back to
[a human in the loop](human-in-the-loop), so either its permissions narrow or
its gates become notifications after the fact.
